...
% % copying and pasting, probably efficient to use a loop so learn how
% % in future lessons
K = 14;
r = 3.2;
P0 = 8;
...
% Problem 3e:
%  Now suppose that P(0) = 0, K = 20 and r = 3.1. Calculate P(500). (This
% is not as mean a problem as it might look.) Save your answer in a variable
% named A15.
% % Note: the starting population is 0, so there will be no population
% % growth and the population will remain constant. So P(500) = 0
A15 = 0;
